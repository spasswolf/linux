...
static int boe5p2_ili7807b_on(struct boe5p2_ili7807b *ctx)
{
	...
	mipi_dsi_dcs_write_seq(dsi, 0x03, 0xee);
	mipi_dsi_dcs_write_seq(dsi, 0x04, 0x16);
	mipi_dsi_dcs_write_seq(dsi, 0x05, 0x11);
	mipi_dsi_dcs_write_seq(dsi, 0x00, 0xfb);
	mipi_dsi_dcs_write_seq(dsi, 0x01, 0x3f);
	mipi_dsi_dcs_write_seq(dsi, 0x02, 0x54);
	mipi_dsi_dcs_write_seq(dsi, 0x08, 0x30);
	mipi_dsi_dcs_write_seq(dsi, 0x10, 0x3e);
	mipi_dsi_dcs_write_seq(dsi, 0x12, 0x3d);
	mipi_dsi_dcs_write_seq(dsi, 0x13, 0x3c);
	mipi_dsi_dcs_write_seq(dsi, 0x14, 0x39);
	mipi_dsi_dcs_write_seq(dsi, 0x16, 0x38);
	mipi_dsi_dcs_write_seq(dsi, 0x1c, 0xfe);
	mipi_dsi_dcs_write_seq(dsi, 0x1d, 0x3d);
	mipi_dsi_dcs_write_seq(dsi, 0x1e, 0xfc);
	mipi_dsi_dcs_write_seq(dsi, 0x1f, 0x3a);
	mipi_dsi_dcs_write_seq(dsi, 0x20, 0x3a);
	mipi_dsi_dcs_write_seq(dsi, 0x21, 0xb4);
	mipi_dsi_dcs_write_seq(dsi, 0x22, 0xf0);
	mipi_dsi_dcs_write_seq(dsi, 0x23, 0xee);
	mipi_dsi_dcs_write_seq(dsi, 0x24, 0xfe);
	mipi_dsi_dcs_write_seq(dsi, 0x25, 0x3e);
	mipi_dsi_dcs_write_seq(dsi, MIPI_DCS_SET_GAMMA_CURVE, 0xfd);
	mipi_dsi_dcs_write_seq(dsi, 0x06, 0x20);
